...
def get_translate_ggss(phenotype):
    beta_uncorrected_map, source_map = get_ggss_maps(phenotype)
...
def main():
    ...
    translate(args.phenotype, 'gene_gene_set_stats', 'ggss.out', get_translate_ggss(args.phenotype))
