...
def gene(spark):
    srcdir = f'{s3_in}/out/old-pigean/combined_gene_stats/*/*/*/*/*.json'
    bioindices = {
...
def gene_set(spark):
    srcdir = f'{s3_in}/out/old-pigean/combined_gene_set_stats/*/*/*/*/*.json'
    bioindices = {
...
def gene_gene_set(spark):
    srcdir = f'{s3_in}/out/old-pigean/gene_gene_set_stats/*/*/*/*/*.json'
    bioindices = {
