...
def main():
    ...
    gene_set_file = udf(lambda tissue, phenotype, direction: f'kids_first_{tissue}_{phenotype}_{direction}' if f'kids_first_{tissue}_{phenotype}_{direction}' in count_map else '')
