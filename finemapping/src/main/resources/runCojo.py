    ...
    for ancestry in ancestries:
        if ancestry in map_ancestry.keys():
            ...
            for chromosome in range(1, 23):
                ...
                cojo_command = f'{dir_cojo}/gcta_1.93.2beta/gcta64 --bfile {file_g1000} --maf 0.005 --chr {chromosome} --cojo-file {file_input} --cojo-wind 10000 --threads 30 --cojo-slct --out {file_output}'
