...
# run magma
gcta64 --bfile /home/javaprog/Data/Broad/100genome/g1000_eas --maf 0.01 --cojo-file part-00000-aa63e7e3-37fc-4208-9b76-043a9d1aa751-c000.csv --cojo-wind 5000 --threads 8 --cojo-slct --out Out/gwas.dude.4
