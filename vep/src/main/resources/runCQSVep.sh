...
perl -I "$VEPDIR/loftee-1.0" "$VEPDIR/ensembl-vep/vep" \
    ...
    --plugin SpliceAI,snv=$VEPDIR/splice_ai/spliceai_scores.masked.snv.ensembl_mane.grch37.110.vcf.gz,indel=$VEPDIR/splice_ai/spliceai_scores.masked.indel.hg37.vcf.gz
