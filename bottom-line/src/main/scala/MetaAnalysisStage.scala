...
class MetaAnalysisStage(implicit context: Context) extends Stage {
  ...
  val variants: Input.Source = Input.Source.Success("furkan-v1/variants/*/*/*/")
  ...
  override def prepareJob(output: String): Unit = {
    context.s3.rm(s"furkan-v1/out/metaanalysis/staging/ancestry-specific/$output/")
    context.s3.rm(s"furkan-v1/out/metaanalysis/staging/trans-ethnic/$output/")
  }
}
